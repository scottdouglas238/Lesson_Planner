  ...
  return (
    <>
      ...
      <div className="column">
        <span className="has-text-white is-size-4 appear">
          Welcome{" "}
      ...
      <div className="container is-fluid">
        <div className="row slideFromRight">
          <h3 className="has-text-white appear">Your Lessons:</h3>
          <LessonTile />
        </div>
        <div className="row">
          <h3 className="has-text-white appear">
            Lessons in your Department:
          </h3>
          <DepartmentTile />
        </div>
      </div>
